...
public class Assignment1_DataTypes {
	...
	public static void main(String[] args) {
		...
		System.out.println("Whether a customer has placed an order:"+ isOrderPlaced );

		
		//3.Person's phone number: "123-456-7890"
		String phnNum = "123-456-7890";
		System.out.println("Person's phone number:"+ phnNum);
		...
		System.out.println("Person's marital status: "+ isMarred);
		...
		int numberOfEmployess = 500;
		System.out.println("Number of employees in a company: "+ numberOfEmployess);
